...
const DrawerContent = () => {
    ...
    return (
        ...
        // subheader={
        //     <IconContext.Provider value={{ size: "28px", color: `${theme.palette.primary.main}` }}>
        //         <ListSubheader
        //             component="div"
            ...
            <IconContext.Provider value={{ className: "drawer-icons" }}>
                ...
                >
                    <List component="div" disablePadding>
                        ...
                        <CustomListItem text="Manage Farmers" href="#" />
                        <CustomListItem text="Manage Sourcing Agents" href="#" />
                    </List>
                </CustomListItem>
                <CustomListItem
                ...
                >
                    <List component="div" disablePadding>
                        <CustomListItem text="Manage Crop Profile" href="/configurations/crop-profile" />
                        <CustomListItem text="Manage Crop Calendar" href="/configurations/crop-calendar" />
                        <CustomListItem text="Manage Farm Seasons" href="/configurations/farm-seasons" />
                    </List>
                </CustomListItem>
                <CustomListItem
                    icon={<FarmIcon />}
